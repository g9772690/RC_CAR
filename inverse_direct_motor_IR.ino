...
void control_SmartCar(String Remote_Val){ 
  ...
  else if(Remote_Val == "1033561079" || Remote_Val == "16718055" ){  // "2" 버튼, 명령 : 전진
    R_Motor = HIGH; L_Motor = HIGH; mode = 0;
    Serial.print("Forward : ");
  }  
  
  else if( Remote_Val == "2351064443" || Remote_Val == "16716015" ){ // "4" 버튼, 명령 : 좌회전
    mode = 2;
    Serial.print("Turn Left : "); 
  }
  
  else if( Remote_Val == "16734885" || Remote_Val == "71952287"){ // "6" 버튼, 명령 : 우회전
    mode = 1;
    Serial.print("Turn Right : "); 
  }
  
  else if( Remote_Val == "16730805" || Remote_Val == "465573243"){ // "8" 버튼, 명령 : 후진
    R_Motor = LOW; L_Motor = LOW; mode = 0;
    Serial.print("Backward : "); 
  }

  else if( Remote_Val == "16726215" || Remote_Val == "1217346747" ){ // "5" 버튼, 명령 : 정지
    mode = 3;
    Serial.print("Stop : ");  
  }
